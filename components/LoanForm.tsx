...
export default function LoanForm({ initialData, onClose, defaultType }: Props) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Name */}
            <div>
                <label className="block text-sm font-medium text-gray-700">{type === "RECEIVABLE" ? "Nama Piutang" : "Nama Hutang"}</label>
                <input
                    required
                    value={name}
            ...
            <div>
                <div className="flex items-center justify-between mb-1">
                    ...
                    <label className="flex items-center gap-1.5 cursor-pointer">
                        ...
                        <span className="text-xs text-gray-500">Ada tenggat</span>
                    </label>
                </div>
                {hasDueDate ? (
                    <input
                    ...
                    <p className="text-xs text-gray-400 italic mt-1">Tanpa tenggat waktu</p>
                )}
            </div>
