        ...
        <section className="py-20 bg-neutral-50 dark:bg-neutral-900/50 overflow-hidden">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold mb-4 text-neutral-900 dark:text-white">Simulasi Sederhana</h2>
                    <p className="text-neutral-600 dark:text-neutral-400">Coba klik tombol di bawah untuk melihat bagaimana Kasaku bekerja secara real-time.</p>
                </div>
