                        ...
                        {categories.filter(c => c.type === "EXPENSE").map(c => (
                            <div key={c.id} className="group flex items-center gap-2 pl-3 pr-2 py-1.5 bg-black/20 rounded-lg border border-white/5 hover:border-white/10 text-sm text-neutral-300 hover:text-white transition-all">
                                ...
                                <button
                                    ...
                                    className="text-neutral-600 hover:text-[#F26076] opacity-0 group-hover:opacity-100 transition-all ml-1 w-5 h-5 flex items-center justify-center rounded hover:bg-[#F26076]/10 disabled:opacity-50"
                                >
                                    {deletingId === c.id ? (
                                        <svg className="animate-spin h-3 w-3 text-[#F26076]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
