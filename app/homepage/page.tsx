...
export default async function Home() {
  ...
  // Allow authenticated users to browse the landing page, 
  // they can click 'Ke Dashboard' in the navbar to return.
  return (
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 py-4 md:py-6 bg-neutral-950/80 backdrop-blur-md border-b border-white/5">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {session ? (
              <Link href="/dashboard" className="px-6 py-2.5 rounded-full bg-gradient-to-r from-[#458B73] to-emerald-600 text-white text-sm font-bold shadow-lg shadow-emerald-900/40 hover:scale-105 transition-transform flex items-center gap-2">
