...
export default function DashboardLoading() {
    ...
    return (
        <main className="min-h-screen pb-20 transition-colors duration-300 bg-gray-50 dark:bg-gray-900">
            {/* ===== HEADER SKELETON ===== */}
            <div className="pt-8 pb-14 rounded-b-3xl shadow-sm relative" style={{ paddingLeft: sideMargin, paddingRight: sideMargin, background: "linear-gradient(135deg, #e5e7eb, #d1d5db)" }}>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10 animate-pulse">
                    {/* Saldo Left */}
                    <div className="p-7 rounded-2xl bg-white/50 h-48"></div>
                    {/* Summary Right */}
                    <div className="flex flex-col gap-6">
                        <div className="p-6 rounded-2xl bg-white/50 h-20"></div>
                        <div className="p-6 rounded-2xl bg-white/50 h-20"></div>
                    </div>
                </section>
            </div>
            ...
            <div className="py-8 space-y-8 md:py-16 md:space-y-16 animate-pulse" style={{ paddingLeft: sideMargin, paddingRight: sideMargin }}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-16">
                    ...
                    <div className="lg:col-span-3 h-[400px] bg-gray-200 dark:bg-gray-800 rounded-2xl"></div>
                </div>
            </div>
        </main>
    );
